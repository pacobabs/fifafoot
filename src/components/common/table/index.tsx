...
const Table = () => {
  ...
  return (
    <div className="sm:hidden md:block md:col-start-11 md:col-span-2 md:row-start-2 md:row-end-4">
      ...
      <div className="hidden md:block text-indigo-50 text-center font-bold bg-gradient-to-r from-indigo-400 via-indigo-500 to-indigo-600 px-1 pt-1 pb-0.5 font-recursive">
        ALL COUNTRIES
      </div>
